...
#Toggle below to compare time taken or numbe of iterations 
B = 0 #FOR TIME TAKEN
#B = 1 #FOR NUMBER OF ITERATIONS

#QA with Hamiltonian, QA without Hamiltonian
for _ in range(100):
	Adj, E, edgno = graph.generate(500, 200)
	print qa(500, Adj, 250, edgno, 0.62, 1.2, 1000, P, 1.0)[B], qa(500, Adj, 250, edgno, 0.62, 1.2, 1000, P, 0.0)[B]
